...
// -------------------------------------------------- //
let addrName = firstName = lastName = email = phone = labels = "";

// Address class
class Address{
    constructor(id, addrName, firstName, lastName, email, phone, labels){
        this.id = id;
...
class UI{
    ...
    static addToAddressList(address){
        ...
        tableRow.innerHTML = `
            ...
            <td>${address.firstName + " " + address.lastName}<br> ${address.phone}<br> ${address.email}</td>
    ...
    modalBtns.addEventListener('click', (event) => {
        ...
        if(event.target.id == "save-btn"){
            ...
            if(!isFormValid){
                ...
                const addressItem = new Address(lastItemId, addrName, firstName, lastName, email, phone, labels);
    ...
    modalBtns.addEventListener('click', (event) => {
        ...
        if(event.target.id == "update-btn"){
            ...
            if(!isFormValid){
                ...
                const addressItem = new Address(id, addrName, firstName, lastName, email, phone, labels);
...
function getFormData(){
    ...
    // console.log(form.addr_ing_name.value, form.first_name.value, form.last_name.value, form.email.value, form.phone.value, form.labels.value);
